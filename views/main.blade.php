...
<div class="container body">
    ...
    <div class="main_container">
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="transcodes.php"><i class="fa fa-reorder"></i> Perfil Codecs </a></li>
                            ...
                            <li><a href="useragentblocks.php"><i class="fa fa-exclamation-triangle"></i> Bloquear User Agent </a></li>
                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a target="_new" href="http://fos-streaming.com"><i class="fa fa-laptop"></i> Sitio Web </a></li>
                            <li><a target="_new" href="https://github.com/zgelici/FOS-Streaming-v1/issues"><i class="fa fa-exclamation-triangle"></i> Reporte </a></li>
                            <li><a target="_new" href="http://www.fos-streaming.com/forum/"><i class="fa fa-circle-o"></i> Foro</a></li>
        ...
        <div class="right_col" role="main">
            ...
            <footer>
                <div class="">
                    <p class="pull-right">FOS-Streaming by Narusuke</a>
